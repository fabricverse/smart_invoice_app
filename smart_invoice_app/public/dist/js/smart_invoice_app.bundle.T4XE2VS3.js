(() => {
  ...
  var require_smart_invoice_setup = __commonJS({
    "../smart_invoice_app/smart_invoice_app/public/js/smart_invoice_setup.js"() {
      return;
  ...
  // ../smart_invoice_app/smart_invoice_app/public/js/smart_invoice_app.bundle.js
  var import_smart_invoice_setup = __toESM(require_smart_invoice_setup());
